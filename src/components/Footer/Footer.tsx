...
<Image src='/logo/png/color.png' alt='logo' width={70} height={70} className=' dark:hidden'/>

</Link>

<Link href='/' className="mb-8 inline-block">

<Image src='/logo/png/white.png' alt='logo' width={70} height={70} className='hidden dark:block'/>
</Link>
...
<ul>
    <li>
        <Link href='/' className="mb-4 inline-block text-base font-medium text-body-color hover:text-primary">
