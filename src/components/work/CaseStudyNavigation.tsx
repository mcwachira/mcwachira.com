...
// Define the shape of a CaseStudy
interface CaseStudy {
  slug: string;
  title: string;
  url: string;
...
// Function to get sorted case studies and index
function getSortedCaseStudiesAndIndex(caseStudySlug: string) {
  const caseStudies: CaseStudy[] = allCaseStudies.sort((a, b) =>
...
// Function to get the previous case study
function prev(caseStudySlug: string) {
...
// Function to get the next case study
function next(caseStudySlug: string) {
  const { caseStudies, index } = getSortedCaseStudiesAndIndex(caseStudySlug);
  return caseStudies[index + 1] ?? caseStudies[0];
}

// Props for CaseStudyNavigation component
interface CaseStudyNavigationProps {
  caseStudySlug: string;
}

export function CaseStudyNavigation({ caseStudySlug }: CaseStudyNavigationProps) {
