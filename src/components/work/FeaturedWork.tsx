...
// Define possible category types
type Category = 'Web Development' | 'Consulting' | 'Branding' | 'Product Development';

// Case study type derived from your data
...
const iconOptions: Record<Category, React.ElementType> = {
...
// CategoryIcon component with category and other props typing
interface CategoryIconProps extends React.SVGProps<SVGElement> {
  category: Category;
}
      ...
      >
        ...
        <div className="relative order-2 px-1 sm:px-4 lg:order-1 lg:col-span-6 lg:pb-16 lg:pl-12 lg:pt-16 xl:col-span-5 xl:pb-24 xl:pl-16 xl:pt-8">
          <div className="inline-flex items-center gap-2.5 text-sm font-medium leading-[16px] text-sky-900/80 sm:text-md">
            {/* Uncomment if CategoryIcon is used */}
            {/* <CategoryIcon
            category={caseStudy.tags[0] as Category}
...
export function FeaturedWork() {
  ...
  return (
      <section className="pt-8 pb-16 bg-light dark:bg-dark overflow-x-clip sm:pb-24 sm:pt-12 md:pt-16">
        <Container className="">
