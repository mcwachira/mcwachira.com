                ...
                {stack.map((tech) => (
                  ...
                  >
                    <div className="flex gap-4 sm:gap-6">
                      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-white shadow-sm shadow-sky-100/75 ring-1 ring-slate-100/95 sm:h-11 sm:w-11">
                        <Image
                          src={tech.logo}
                          alt={tech.name}
